...
export function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  const adminNavItems: AdminNavItem[] = [
    ...
    { to: routePaths.admin.categorySchemas, label: t("navigation:categorySchemas"), icon: Settings2, end: true, roles: ["ADMIN"] },
    { to: routePaths.admin.betaFeedback, label: t("navigation:betaFeedback"), icon: MessageSquareQuote, end: true, roles: ["ADMIN"] },
